...
std::vector<std::string> ntkp_syst_list = {"signal_pdf_syst","cb_pdf_syst","mass_window_syst"};
std::vector<std::string> ntkstar_syst_list = {"signal_pdf_syst","cb_pdf_syst","mass_window_syst"};
std::vector<std::string> ntphi_syst_list = {"signal_pdf_syst","cb_pdf_syst","mass_window_syst"};
